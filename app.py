...
app = Flask(__name__)  #The most important line. Everything after this line will appear on the website.
...
# We used a for loop to iterate through a random combination of numbers and letters and combine it with the string "CONF-"
...
# This function returns the CSS (language that controls how the website looks) styles for the whole website
def get_styles():
    return """
    <style>
        body {
...
# This keeps us from copying the same HTML over and over. Header
...
# This function ends every page. Footer
def end_page():
